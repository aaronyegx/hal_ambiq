//*****************************************************************************
//
//! @file am_devices_ble_ctrl.h
//!
//! @brief An implementation of the Apollo inteface to Controller using the IOM.
//!
//! @addtogroup controller Controller BLE Device Driver
//! @ingroup devices
//! @{
//
//*****************************************************************************

#ifndef AM_DEVICES_BLE_CTRL_H
#define AM_DEVICES_BLE_CTRL_H
...
//
//*****************************************************************************
#define am_devices_ble_ctrl_buffer(A)                                         \
    union                                                                     \
    {                                                                         \
...
typedef enum
{
    AM_DEVICES_BLE_CTRL_STATUS_SUCCESS,
    AM_DEVICES_BLE_CTRL_STATUS_ERROR,
    //
    ...
    //
    AM_DEVICES_BLE_CTRL_STATUS_BUS_BUSY,
    ...
    //
    AM_DEVICES_BLE_CTRL_STATUS_CONTROLLER_NOT_READY,

    //
    //! Wrong length of data been read back (==0 or > 260)
    //
    AM_DEVICES_BLE_CTRL_STATUS_WRONG_DATA_LENGTH,
    ...
    //! need to restart.
    //
    AM_DEVICES_BLE_CTRL_STATUS_NO_RESPONSE,

    //
    //! The transaction ends up in error and cannot finish the HCI packet R/W
    //
    AM_DEVICES_BLE_CTRL_STATUS_PACKET_INCOMPLETE,

    //
    //! The CQ does not complete transaction before times out
    //
    AM_DEVICES_BLE_CTRL_STATUS_TIMEOUT,
    AM_DEVICES_BLE_CTRL_STATUS_INVALID_OPERATION,
} am_devices_ble_ctrl_status_t;
...
typedef enum
{
    ...
    //! Ambiq Vendor Specific Command flash info0 trim values to controller
...
#define HCI_VSC_CMD(CMD, ...)                          {AM_DEVICES_BLE_CTRL_CMD, UINT16_TO_BYTE0(CMD##_CMD_OPCODE), UINT16_TO_BYTE1(CMD##_CMD_OPCODE), CMD##_CMD_LENGTH, ##__VA_ARGS__}
#define HCI_RAW_CMD(OPCODE, LEN, ...)                  {AM_DEVICES_BLE_CTRL_CMD, UINT16_TO_BYTE0(OPCODE), UINT16_TO_BYTE1(OPCODE), LEN, ##__VA_ARGS__}
...
#define AM_DEVICES_BLE_CTRL_SBL_UPDATE_STATE_INIT                     0x00
#define AM_DEVICES_BLE_CTRL_SBL_UPDATE_STATE_HELLO                    0x01
#define AM_DEVICES_BLE_CTRL_SBL_UPDATE_STATE_UPDATE                   0x02
#define AM_DEVICES_BLE_CTRL_SBL_UPDATE_STATE_DATA                     0x03
#define AM_DEVICES_BLE_CTRL_SBL_UPDATE_STATE_IMAGE_OK                 0x04

#define AM_DEVICES_BLE_CTRL_SBL_UPDATE_IMAGE_TYPE_FW                  0x00
#define AM_DEVICES_BLE_CTRL_SBL_UPDATE_IMAGE_TYPE_INFO_0              0x01
#define AM_DEVICES_BLE_CTRL_SBL_UPDATE_IMAGE_TYPE_INFO_1              0x02
#define AM_DEVICES_BLE_CTRL_SBL_UPDATE_IMAGE_TYPE_NONE                0x03

#define AM_DEVICES_BLE_CTRL_SBL_UPADTE_MAX_SPI_PKT_SIZE               0x200
#define AM_DEVICES_BLE_CTRL_SBL_UPADTE_INVALID_PSI_PKT_SIZE           0xFFFFFFFF
#define AM_DEVICES_BLE_CTRL_SBL_UPADTE_IMAGE_HDR_SIZE                 0x40

#define AM_DEVICES_BLE_CTRL_SBL_MAX_COMM_ERR_COUNT                    0x03

#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_SUCCESS                      0x00
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_FAIL                         0x01
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_BAD_HDR                      0x02
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_BAD_CRC                      0x03
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_VERSION_INVALID              0x04
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_MSG_TOO_BIG                  0x05
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_UNKNOWN_MSG                  0x06
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_INVALID_ADDRESS              0x07
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_INVALID_OPERATION            0x08
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_INVALID_PARAM                0x09
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_INVALID_DATA_LEN             0x0A
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_SEQ                          0x0B
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_TOO_BIG_DATA                 0x0C
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_BAD_IMAGE                    0x0D
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_FLASH_WRITE_FAILED           0x0E
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_INVALID_DEVICE_ID            0x0F
#define AM_DEVICES_BLE_CTRL_SBL_ACK_RESP_BAD_KEY                      0x10

#define AM_DEVICES_BLE_CTRL_SBL_STAT_RESP_SUCCESS                     0x00
#define AM_DEVICES_BLE_CTRL_SBL_STAT_RESP_FAIL                        0x01
#define AM_DEVICES_BLE_CTRL_SBL_STAT_RESP_BAD_HDR                     0x02
#define AM_DEVICES_BLE_CTRL_SBL_STAT_RESP_BAD_CRC                     0x03
#define AM_DEVICES_BLE_CTRL_SBL_STAT_RESP_STAT_BAD_SBL                0x04
#define AM_DEVICES_BLE_CTRL_SBL_STAT_RESP_BAD_IMAGE                   0x05
#define AM_DEVICES_BLE_CTRL_SBL_STAT_RESP_UNKNOWN_MSG                 0x06
#define AM_DEVICES_BLE_CTRL_SBL_STAT_RESP_FW_UPDATE_REQ               0x07
#define AM_DEVICES_BLE_CTRL_SBL_STAT_RESP_INFO0_UPDATE_REQ            0x08
#define AM_DEVICES_BLE_CTRL_SBL_STAT_RESP_INFO1_UPDATE_REQ            0x09

#define AM_DEVICES_BLE_CTRL_SBL_STATUS_INIT                           0x00000000
#define AM_DEVICES_BLE_CTRL_SBL_STATUS_OK                             0xA5A5A5A5
#define AM_DEVICES_BLE_CTRL_SBL_STATUS_FAIL                           0xA1A1A1A1
#define AM_DEVICES_BLE_CTRL_SBL_STATUS_CRC_FAIL                       0xA2A2A2A2
#define AM_DEVICES_BLE_CTRL_SBL_STATUS_UPDATE_FW                      0x4598F231
#define AM_DEVICES_BLE_CTRL_SBL_STATUS_UPDATE_INFO_0                  0x8730DA5B
#define AM_DEVICES_BLE_CTRL_SBL_STATUS_UPDATE_INFO_1                  0x09FA3725
#define AM_DEVICES_BLE_CTRL_SBL_STATUS_IN_PROGRESS                    0xA78BD32C
#define AM_DEVICES_BLE_CTRL_SBL_STATUS_UPDATE_IMAGE_FAIL              0xA3A3A3A3

#define AM_DEVICES_BLE_CTRL_SBL_DEFAULT_FW_VERSION                    0xFFFFFFFF

#define AM_DEVICES_BLE_CTRL_SBL_STAT_VER_ROLL_BACK_EN                 0xFFFFFFFF
#define AM_DEVICES_BLE_CTRL_SBL_STAT_VER_ROLL_BACK_DBL                0xFFFFFF00

#define AM_DEVICES_BLE_CTRL_SBL_FW_IMAGE_ADDRESS                      0x10030000
#define AM_DEVICES_BLE_CTRL_SBL_FW_IMAGE_SIZE                         0x22890
#define AM_DEVICES_BLE_CTRL_SBL_FW_IMAGE_SIZE_MAX                     0x30000

#define AM_DEVICES_BLE_CTRL_SBL_INFO0_PATCH_ADDRESS                   AM_DEVICES_BLE_CTRL_SBL_FW_IMAGE_ADDRESS +  AM_DEVICES_BLE_CTRL_SBL_FW_IMAGE_SIZE_MAX
#define AM_DEVICES_BLE_CTRL_SBL_INFO0_PATCH_SIZE                      0x180
#define AM_DEVICES_BLE_CTRL_SBL_INFO0_PATCH_SIZE_MAX                  0x200

#define AM_DEVICES_BLE_CTRL_SBL_INFO1_PATCH_ADDRESS                   AM_DEVICES_BLE_CTRL_SBL_INFO0_PATCH_ADDRESS +  AM_DEVICES_BLE_CTRL_SBL_INFO0_PATCH_SIZE_MAX
#define AM_DEVICES_BLE_CTRL_SBL_INFO1_PATCH_SIZE                      0x80
#define AM_DEVICES_BLE_CTRL_SBL_INFO1_PATCH_SIZE_MAX                  0x100

//! Signatures for the image downloads
#define CONTROLLER_FW_UPDATE_SIGN                                     0xC593876A
...
typedef struct
{
    ...
    uint32_t    imageType;
    uint32_t    version;
} am_devices_ble_ctrl_sbl_update_data_t;
...
typedef struct
{
    ...
    uint32_t    ui32ControllerFWImageVersion;
    uint32_t    ui32ControllerSblStatus;
    uint32_t    ui32ControllerVerRollBackConfig; //Version 2
    uint32_t    ui32copperChipIdWord0;  //Version 2
    uint32_t    ui32copperChipIdWord1;  //Version 2
} am_devices_ble_ctrl_sbl_update_state_t;
...
//
extern uint8_t am_ble_ctrl_nvds_data[];
//*****************************************************************************
//
//! @brief Update BLE Controller firmare.
//! @return 0 is success
//
//*****************************************************************************
...
//*****************************************************************************
//
//! @brief Pre-initialize the Controller Image Update state machine
//
//*****************************************************************************
...
//*****************************************************************************
//
//! @brief Get controller firmware image from local binary
//! @param pFwImage
...
//! @param pBuf pointer of received data
//
//*****************************************************************************
